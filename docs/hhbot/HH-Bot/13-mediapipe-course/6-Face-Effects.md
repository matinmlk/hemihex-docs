...
```bash
roscore
rosrun jetcobot_mediapipe 06_FaceLandmarks.py
```

![image-20231016104618900](/img/docs/hhbot/13-mediapipe-course/13-6/image-20231016104618900.png)

#### 2.2 About code

Code path：~/jetcobot_ws/src/jetcobot_mediapipe/scripts/06_FaceLandmarks.py
