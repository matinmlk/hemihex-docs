...
![image-20250122095925818](/img/docs/hh101/05-VisionBasicCourse/5-1/image-20250122095925818.png)

Press the arrow keys to select Configure Jetson 24pin CSI Connector , then press Enter to enter the configuration:

![image-20250122095938796](/img/docs/hh101/05-VisionBasicCourse/5-1/image-20250122095938796.png)

Select Configure for compatible hardware , then press Enter to enter the configuration:

![image-20250122095957948](/img/docs/hh101/05-VisionBasicCourse/5-1/image-20250122095957948.png)

Select Camera IMX219 Dual , then press Enter to enter the configuration:

![image-20250122100005445](/img/docs/hh101/05-VisionBasicCourse/5-1/image-20250122100005445.png)

Select Save pin changes , then press Enter to enter the configuration:

![image-20250122100037447](/img/docs/hh101/05-VisionBasicCourse/5-1/image-20250122100037447.png)

Select Save and reboot to reconfigure pins , and then wait for the system to restart:

![image-20250122100100675](/img/docs/hh101/05-VisionBasicCourse/5-1/image-20250122100100675.png)
...
![image-20250110120003496](/img/docs/hh101/05-VisionBasicCourse/5-1/image-20250110120003496.png)
...
![image-20250110120335665](/img/docs/hh101/05-VisionBasicCourse/5-1/image-20250110120335665.png)
...
![image-20250110120513459](/img/docs/hh101/05-VisionBasicCourse/5-1/image-20250110120513459.png)
...
![image-20250110120704726](/img/docs/hh101/05-VisionBasicCourse/5-1/image-20250110120704726.png)
